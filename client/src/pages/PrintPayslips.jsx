...
const PrintPayslips = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <div>
          ...
          <p className="font-semibold text-slate-900">{format(new Date(payslip.year, payslip.month - 1), "MMMM yyyyy")}</p>
        </div>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className=" bg-slate-50">
              <th className="text-left py-3 px-4 text-xs text-slate-500 uppercase tracking-tight">Description</th>
