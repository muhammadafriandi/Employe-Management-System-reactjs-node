import { AlertCircleIcon, CalendarRangeIcon, ClockIcon } from 'lucide-react'
...
const AttendanceStats = ({ history }) => {
  ...
  const stats = [
    { label: 'Days Present', value: totalPresent, icon: CalendarRangeIcon },
    { label: 'Late Arrivals', value: totalLate, icon: AlertCircleIcon },
    { label: 'Avg. work hors', value: '8.5 Hrs', icon: ClockIcon }
  ]
