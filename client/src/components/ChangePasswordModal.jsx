...
const ChangePasswordModal = ({ open, onClose }) => {
  ...
  return (
    <div onClick={onClose} className='fixed inset-0 flex items-center justify-center p-4'>
      <div className='absolute inset-0 bg-black/40 bacdrop-blur-sm' />
      ...
      <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in' onClick={(e) => e.stopPropagation()}>
        ...
        <form onClick={handleSubmit} className='p-6 space-y-5'>
          {message.text && (
          ...
          <div className='flex gap-3 pt-2'>
            ...
            <button type='submit' className='btn-primary flex-1 flex justify-center gap-2' disabled={loading}>
